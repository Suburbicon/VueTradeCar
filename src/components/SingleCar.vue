<template>
  <v-col class="single-car" cols="12" md="6" lg="4" xl="3">
    <v-card class="mx-auto my-2 blue-grey lighten-4" max-width="400">
      ...
      <v-card-subtitle
        v-if="!showEdit"
        class="pb-0 headline blue-grey--text text--darken-4"
      ...
      >
        ...
        <v-btn text icon color="blue-grey" @click="updatePrice">
          <v-icon>save</v-icon>
        </v-btn>
      </v-card-subtitle>

      <v-card-text class="white--text mt-2 body-3 blue-grey pt-3 card-text">
        <div class="miles">
      ...
      <v-card-actions v-if="!error && $auth.isAuthenticated">
        ...
        <v-btn class="blue-grey--text" text @click="buyCar">Sell</v-btn>
        <v-btn class="blue-grey--text" text @click="delCar">Del</v-btn>
      </v-card-actions>
      <v-card-actions v-if="error">
        <div class="errorMSG blue-grey white--text body-1 px-4">
          {{ error }}
        </div>
      </v-card-actions>
    </v-card>
